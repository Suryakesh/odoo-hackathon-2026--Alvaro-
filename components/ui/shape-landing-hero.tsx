...
function HeroGeometric({
    ...
    title1 = "Smart Transport",
    title2 = "Operations, Simplified",
}: {
    badge?: string;
    title1?: string;
    title2?: string;
    ...
    return (
        <div className="dark relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
                        <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            Digitize vehicle, driver, dispatch, and maintenance management — replace spreadsheets with real-time fleet visibility.
                        </p>
                    </motion.div>
